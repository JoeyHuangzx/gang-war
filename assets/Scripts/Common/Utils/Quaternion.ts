import { Quat,Node, Vec3, IVec3Like, IVec3 } from "cc";
...
export class Quaternion {
     ...
     * @param _quat 四元数
     */
    public static GetEulerFromQuat(_quat: Quat): Vec3 {
        let angle: IVec3 = Quat.toEuler(new Vec3(), _quat, true);
        return new Vec3(angle.x,angle.y,angle.z);
    }
